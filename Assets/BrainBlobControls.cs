    ...
    if(alive == true)
    {
       ...
       int rCo = 10 + (int)Mathf.Pow((lifeLength/age),2f); 
        ...
        {   
            ...
            this.GetComponent<BrainBlob>().enabled = false;
            if(energy <= 0f)
            {   
            ...
            if( alive == true){
                ...
                {               
                    if(booper.layer == 6)
                    {
                        energy += 100f + (booper.GetComponent<BrainBlobControls>().pEnergy)/2f;
                    }
                    if(booper.layer == 7)
                    {
                ...
                {
                    mate = booper.GetComponent<BrainBlobControls>();
        ...
        if(blueAllele2 < 0.0f){blueAllele2 = 0.0f;}
            ...
            {   
                ...
                transform.localScale = newSize;
                    ...
                    clone.GetComponent<BrainBlobControls>().generation +=1;
                    clone.GetComponent<BrainBlobControls>().age = 0f;
                    rCount += 1;
